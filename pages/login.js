      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={(e) => handleSubmit(e)} method="POST">
          ...
          <div className="-space-y-px rounded-md shadow-sm">
            <div className="mb-3">
              <input value={email} onChange={(e) => handleChange(e)} id="email" name="email" type="email" required className="relative block w-full rounded-t-md border-0 px-2 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Email address" />
            </div>
            <div className="mb-3">
              <input value={password} onChange={(e) => handleChange(e)} id="password" name="password" type="password" required className="relative block w-full rounded-b-md border-0 px-2 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Password" />
            </div>
          </div>
